 ...
 */
static UX_INLINE void __list_add(struct list_head *new1,
 ...
 */
static UX_INLINE void list_add(struct list_head *new1, struct list_head *head)
{
 ...
 */
static UX_INLINE void list_add_tail(struct list_head *new1, struct list_head *head)
{
